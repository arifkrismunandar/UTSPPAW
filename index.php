<html>
    ...
    <body bgcolor="#E9967A"><br />
        <div align="center">
            <form name="form-login" method="POST" action="login.php">
                <table width="310" border="0" cellpadding="0" cellspacing="0">
                    <tr bgcolor="#CD5C5C">
                        <td height="25" colspan="2" align="center"><font color="#FFFFF0">Form Login Admin MaLilStuff</font></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="username" size="20" maxlength="9"></td>
                    </tr>
                    <tr>
                        <td> </td>
                        <td> </td>
